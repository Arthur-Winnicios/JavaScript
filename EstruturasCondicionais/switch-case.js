...
function exibirInfoClasse(classe) {
    switch (classe) {
        case "Guerreiro":
            ...
            console.log("Descrição: Os guerreiros são combatentes corpo a corpo resistentes, especializados no uso de armas e armadura pesadas");
            console.log("Habilidades: Ataque poderoso, resistência a danos");
            break;
        case "Mago":
            console.log("Classe: Mago");
            console.log("Descrição: Os magos são mestres do poder arcano, capazes de lançar feitiços poderosos e ccontrolar os elementos");
